/*
  ...
  - You are about to drop the column `serviceId` on the `Invoice` table. All the data in the column will be lost.
  ...
  - Added the required column `transactionId` to the `Invoice` table without a default value. This is not possible if the table is not empty.
